...
.endm
        ...
        .global Exit_Kernel
        .global Enter_Kernel
        .extern  kernelStackPointer
        .extern  currentTaskStackPointer
/*
...
Exit_Kernel:
        ...
        /* 
          ...
          * Save the current H/W stack pointer into kernelStackPointer.
          */
        in   r30, SPL
        in   r31, SPH
        sts  kernelStackPointer, r30
        sts  kernelStackPointer+1, r31
        /*
          * We are now ready to restore Cp's context, i.e.,
          * switching the H/W stack pointer to currentTaskStackPointer.
          */ 
        lds  r30, currentTaskStackPointer
        lds  r31, currentTaskStackPointer+1
        out  SPL, r30
        out  SPH, r31
        /*
...
Enter_Kernel:   
        ...
        /* 
          ...
          * Save the current H/W stack pointer into currentTaskStackPointer.
          */
        in   r30, SPL
        in   r31, SPH
        sts  currentTaskStackPointer, r30
        sts  currentTaskStackPointer+1, r31
        /*
          * We are now ready to restore kernel's context, i.e.,
          * switching the H/W stack pointer back to kernelStackPointer.
          */ 
        lds  r30, kernelStackPointer
        lds  r31, kernelStackPointer+1
        out  SPL, r30
        out  SPH, r31
        /*
